 ...
 * @const
 */
tutao.entity.tutanota.MailboxGroupRoot.MODEL_VERSION = '23';
...
tutao.entity.tutanota.MailboxGroupRoot.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.tutanota.MailboxGroupRoot, tutao.entity.tutanota.MailboxGroupRoot.PATH, id, null, {"v" : "23"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
    return entity;
  });
};
...
tutao.entity.tutanota.MailboxGroupRoot.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.tutanota.MailboxGroupRoot, tutao.entity.tutanota.MailboxGroupRoot.PATH, ids, {"v": "23"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
    return entities;
  });
};
...
tutao.entity.tutanota.MailboxGroupRoot.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.tutanota.MailboxGroupRoot.PATH, this, {"v": "23"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
