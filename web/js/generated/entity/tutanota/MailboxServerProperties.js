 ...
 * @const
 */
tutao.entity.tutanota.MailboxServerProperties.MODEL_VERSION = '22';
...
tutao.entity.tutanota.MailboxServerProperties.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.tutanota.MailboxServerProperties, tutao.entity.tutanota.MailboxServerProperties.PATH, id, null, {"v" : "22"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
    return entity;
  });
};
...
tutao.entity.tutanota.MailboxServerProperties.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.tutanota.MailboxServerProperties, tutao.entity.tutanota.MailboxServerProperties.PATH, ids, {"v": "22"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
    return entities;
  });
};
...
tutao.entity.tutanota.MailboxServerProperties.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.tutanota.MailboxServerProperties.PATH, this, {"v": "22"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
