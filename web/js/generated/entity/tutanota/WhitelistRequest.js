 ...
 * @const
 */
tutao.entity.tutanota.WhitelistRequest.MODEL_VERSION = '25';
...
tutao.entity.tutanota.WhitelistRequest.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.tutanota.WhitelistRequest, tutao.entity.tutanota.WhitelistRequest.PATH, id[1], id[0], {"v" : "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
    return entity;
  });
};
...
tutao.entity.tutanota.WhitelistRequest.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.tutanota.WhitelistRequest, tutao.entity.tutanota.WhitelistRequest.PATH, ids, {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
    return entities;
  });
};
...
tutao.entity.tutanota.WhitelistRequest.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.tutanota.WhitelistRequest.PATH, this, {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
...
tutao.entity.tutanota.WhitelistRequest.loadRange = function(listId, start, count, reverse) {
  return tutao.locator.entityRestClient.getElementRange(tutao.entity.tutanota.WhitelistRequest, tutao.entity.tutanota.WhitelistRequest.PATH, listId, start, count, reverse, {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {;
    return entities;
  });
};
