 ...
 * @const
 */
tutao.entity.tutanota.MailFolder.MODEL_VERSION = '24';
...
tutao.entity.tutanota.MailFolder.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.tutanota.MailFolder, tutao.entity.tutanota.MailFolder.PATH, id[1], id[0], {"v" : "24"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
...
tutao.entity.tutanota.MailFolder.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.tutanota.MailFolder, tutao.entity.tutanota.MailFolder.PATH, ids, {"v": "24"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
...
tutao.entity.tutanota.MailFolder.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.tutanota.MailFolder.PATH, this, {"v": "24"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
...
tutao.entity.tutanota.MailFolder.loadRange = function(listId, start, count, reverse) {
  return tutao.locator.entityRestClient.getElementRange(tutao.entity.tutanota.MailFolder, tutao.entity.tutanota.MailFolder.PATH, listId, start, count, reverse, {"v": "24"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {;
    return tutao.entity.EntityHelper.loadSessionKeys(entities);
  });
};
