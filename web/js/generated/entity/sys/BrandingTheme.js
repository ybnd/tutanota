 ...
 * @const
 */
tutao.entity.sys.BrandingTheme.MODEL_VERSION = '27';
...
tutao.entity.sys.BrandingTheme.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.sys.BrandingTheme, tutao.entity.sys.BrandingTheme.PATH, id, null, {"v" : "27"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
    return entity;
  });
};
...
tutao.entity.sys.BrandingTheme.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.sys.BrandingTheme, tutao.entity.sys.BrandingTheme.PATH, ids, {"v": "27"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
    return entities;
  });
};
...
tutao.entity.sys.BrandingTheme.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.sys.BrandingTheme.PATH, this, {"v": "27"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
