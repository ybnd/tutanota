 ...
 * @const
 */
tutao.entity.sys.Session.MODEL_VERSION = '25';
...
tutao.entity.sys.Session.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.sys.Session, tutao.entity.sys.Session.PATH, id[1], id[0], {"v" : "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
...
tutao.entity.sys.Session.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.sys.Session, tutao.entity.sys.Session.PATH, ids, {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
...
tutao.entity.sys.Session.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.sys.Session.PATH, this, {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
...
tutao.entity.sys.Session.prototype.erase = function() {
  var self = this;
  return tutao.locator.entityRestClient.deleteElement(tutao.entity.sys.Session.PATH, this.__id[1], this.__id[0], {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(data) {
...
tutao.entity.sys.Session.loadRange = function(listId, start, count, reverse) {
  return tutao.locator.entityRestClient.getElementRange(tutao.entity.sys.Session, tutao.entity.sys.Session.PATH, listId, start, count, reverse, {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {;
    return tutao.entity.EntityHelper.loadSessionKeys(entities);
  });
};
