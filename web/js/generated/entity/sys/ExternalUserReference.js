 ...
 * @const
 */
tutao.entity.sys.ExternalUserReference.MODEL_VERSION = '28';
...
tutao.entity.sys.ExternalUserReference.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.sys.ExternalUserReference, tutao.entity.sys.ExternalUserReference.PATH, id[1], id[0], {"v" : "28"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
    return entity;
  });
};
...
tutao.entity.sys.ExternalUserReference.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.sys.ExternalUserReference, tutao.entity.sys.ExternalUserReference.PATH, ids, {"v": "28"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
    return entities;
  });
};
...
tutao.entity.sys.ExternalUserReference.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.sys.ExternalUserReference.PATH, this, {"v": "28"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
...
tutao.entity.sys.ExternalUserReference.loadRange = function(listId, start, count, reverse) {
  return tutao.locator.entityRestClient.getElementRange(tutao.entity.sys.ExternalUserReference, tutao.entity.sys.ExternalUserReference.PATH, listId, start, count, reverse, {"v": "28"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {;
    return entities;
  });
};
