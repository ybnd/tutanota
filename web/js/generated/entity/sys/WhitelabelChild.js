 ...
 * @const
 */
tutao.entity.sys.WhitelabelChild.MODEL_VERSION = '28';
...
tutao.entity.sys.WhitelabelChild.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.sys.WhitelabelChild, tutao.entity.sys.WhitelabelChild.PATH, id[1], id[0], {"v" : "28"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
...
tutao.entity.sys.WhitelabelChild.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.sys.WhitelabelChild, tutao.entity.sys.WhitelabelChild.PATH, ids, {"v": "28"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
...
tutao.entity.sys.WhitelabelChild.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.sys.WhitelabelChild.PATH, this, {"v": "28"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
...
tutao.entity.sys.WhitelabelChild.loadRange = function(listId, start, count, reverse) {
  return tutao.locator.entityRestClient.getElementRange(tutao.entity.sys.WhitelabelChild, tutao.entity.sys.WhitelabelChild.PATH, listId, start, count, reverse, {"v": "28"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {;
    return tutao.entity.EntityHelper.loadSessionKeys(entities);
  });
};
