 ...
 * @const
 */
tutao.entity.sys.SecondFactor.MODEL_VERSION = '27';
...
tutao.entity.sys.SecondFactor.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.sys.SecondFactor, tutao.entity.sys.SecondFactor.PATH, id[1], id[0], {"v" : "27"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
    return entity;
  });
};
...
tutao.entity.sys.SecondFactor.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.sys.SecondFactor, tutao.entity.sys.SecondFactor.PATH, ids, {"v": "27"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
    return entities;
  });
};
...
tutao.entity.sys.SecondFactor.prototype.setup = function(listId) {
  ...
  return tutao.locator.entityRestClient.postElement(tutao.entity.sys.SecondFactor.PATH, self, listId, {"v": "27"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
...
tutao.entity.sys.SecondFactor.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.sys.SecondFactor.PATH, this, {"v": "27"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
    self._entityHelper.notifyObservers(false);
  });
};
...
tutao.entity.sys.SecondFactor.loadRange = function(listId, start, count, reverse) {
  return tutao.locator.entityRestClient.getElementRange(tutao.entity.sys.SecondFactor, tutao.entity.sys.SecondFactor.PATH, listId, start, count, reverse, {"v": "27"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {;
    return entities;
  });
};
