 ...
 * @const
 */
tutao.entity.sys.Domain.MODEL_VERSION = '25';
...
tutao.entity.sys.Domain.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.sys.Domain, tutao.entity.sys.Domain.PATH, id[1], id[0], {"v" : "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
    return entity;
  });
};
...
tutao.entity.sys.Domain.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.sys.Domain, tutao.entity.sys.Domain.PATH, ids, {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
    return entities;
  });
};
...
tutao.entity.sys.Domain.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.sys.Domain.PATH, this, {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
...
tutao.entity.sys.Domain.loadRange = function(listId, start, count, reverse) {
  return tutao.locator.entityRestClient.getElementRange(tutao.entity.sys.Domain, tutao.entity.sys.Domain.PATH, listId, start, count, reverse, {"v": "25"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {;
    return entities;
  });
};
