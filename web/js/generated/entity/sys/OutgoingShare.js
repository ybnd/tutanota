 ...
 * @const
 */
tutao.entity.sys.OutgoingShare.MODEL_VERSION = '24';
...
tutao.entity.sys.OutgoingShare.load = function(id) {
  return tutao.locator.entityRestClient.getElement(tutao.entity.sys.OutgoingShare, tutao.entity.sys.OutgoingShare.PATH, id[1], id[0], {"v" : "24"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entity) {
    return entity;
  });
};
...
tutao.entity.sys.OutgoingShare.loadMultiple = function(ids) {
  return tutao.locator.entityRestClient.getElements(tutao.entity.sys.OutgoingShare, tutao.entity.sys.OutgoingShare.PATH, ids, {"v": "24"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {
    return entities;
  });
};
...
tutao.entity.sys.OutgoingShare.prototype.update = function() {
  var self = this;
  return tutao.locator.entityRestClient.putElement(tutao.entity.sys.OutgoingShare.PATH, this, {"v": "24"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function() {
...
tutao.entity.sys.OutgoingShare.loadRange = function(listId, start, count, reverse) {
  return tutao.locator.entityRestClient.getElementRange(tutao.entity.sys.OutgoingShare, tutao.entity.sys.OutgoingShare.PATH, listId, start, count, reverse, {"v": "24"}, tutao.entity.EntityHelper.createAuthHeaders()).then(function(entities) {;
    return entities;
  });
};
